from Anim_Manager.events import register
from Anim_Manager import telethn as tbot
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("**Uploaded To Telegraph!\n\n👉  https://telegra.ph{}\n\nUploaded by @@AnimX_Robot 🇱🇰**".format(media_urls[0]),link_preview=True)
        elif input_str == "xt":
